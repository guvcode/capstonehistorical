...
const getLetterGrade = (score: number) => {
  ...
  if (score >= 95 && score <= 100) letterGrade = "A+";
  if (score >= 90 && score <= 94.9) letterGrade = "A-";
  if (score >= 85 && score <= 89.9) letterGrade = "B+";
  if (score >= 79.5 && score <= 84.9) letterGrade = "B-";
  if (score >= 70.9 && score <= 79.4) letterGrade = "C+";
  if (score >= 60 && score <= 70.8) letterGrade = "C";
  if (score >= 50 && score <= 59.9) letterGrade = "C-";
  if (score >= 0 && score <= 49.9) letterGrade = "F";
